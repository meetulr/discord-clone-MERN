...
import { MemberObject, ProfileObject, ServerObject } from "@/lib/object-types";
...
export const ServerMember = ({
  ...
  return (
    ...
    >
      <UserAvatar
        src={typeof member.profileId !== "string" ? member.profileId.imageUrl : ""}
      ...
      >
        { typeof member.profileId !== "string" && member.profileId.name}
      </p>
      {icon}
    </button>
  );
